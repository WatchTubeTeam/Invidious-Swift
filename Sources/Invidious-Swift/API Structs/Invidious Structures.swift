...
public struct InvChannelVideoElement: Codable {
    public let type: String
...
public struct InvVideo: Codable {
    ...
    public let viewCount, likeCount, dislikeCount: Int
...
public struct InvChannel: Codable {
    ...
    public let allowedRegions: [String]
    public let latestVideos: [InvChannelVideoElement]
...
public struct InvSearchElement: Codable {
    public let type: String
    public let author, authorID, authorURL: String
    public let authorThumbnails: [InvAuthorThumbnail]?
    public let autoGenerated: Bool?
    public let subCount, videoCount: Int?
